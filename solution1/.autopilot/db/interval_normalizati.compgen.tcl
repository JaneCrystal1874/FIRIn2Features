...
set ID 17
set hasByteEnable 0
set MemName interval_normalizdEe
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_peaks_V_V \
    op interface \
    ports { peaks_V_V_dout { I 10 vector } peaks_V_V_empty_n { I 1 bit } peaks_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 19 \
    name normalized_out_V \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_normalized_out_V \
    op interface \
    ports { normalized_out_V_din { O 32 vector } normalized_out_V_full_n { I 1 bit } normalized_out_V_write { O 1 bit } } \
} "
}
