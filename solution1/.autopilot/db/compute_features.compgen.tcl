...
set ID 34
set hasByteEnable 0
set MemName compute_features_jbC
...
set ID 35
set hasByteEnable 0
set MemName compute_features_kbM
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 199
...
eval "cg_default_interface_gen_dc { \
    id 36 \
    name normalized_in_V \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_normalized_in_V \
    op interface \
    ports { normalized_in_V_dout { I 32 vector } normalized_in_V_empty_n { I 1 bit } normalized_in_V_read { O 1 bit } } \
} "
}
