...
// ==============================================================
#ifndef __feature_extractorncg__HH__
#define __feature_extractorncg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(feature_extractorncg) {
    ...
    SC_CTOR(feature_extractorncg):  ACMP_fpext_U ("ACMP_fpext_U") {
