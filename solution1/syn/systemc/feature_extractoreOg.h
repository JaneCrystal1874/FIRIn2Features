...
// ==============================================================
#ifndef __feature_extractoreOg__HH__
#define __feature_extractoreOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(feature_extractoreOg) {
    ...
    SC_CTOR(feature_extractoreOg):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
