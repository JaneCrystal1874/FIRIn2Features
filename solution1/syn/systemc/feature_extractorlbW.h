...
// ==============================================================
#ifndef __feature_extractorlbW__HH__
#define __feature_extractorlbW__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(feature_extractorlbW) {
    ...
    SC_CTOR(feature_extractorlbW):  ACMP_sitofp_U ("ACMP_sitofp_U") {
