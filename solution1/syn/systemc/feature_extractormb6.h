...
// ==============================================================
#ifndef __feature_extractormb6__HH__
#define __feature_extractormb6__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(feature_extractormb6) {
    ...
    SC_CTOR(feature_extractormb6):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
