...
// ==============================================================
#ifndef __feature_extractorcud__HH__
#define __feature_extractorcud__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(feature_extractorcud) {
    ...
    SC_CTOR(feature_extractorcud):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
