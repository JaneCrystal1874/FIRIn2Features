...
// ==============================================================
#ifndef __feature_extractoribs__HH__
#define __feature_extractoribs__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(feature_extractoribs) {
    ...
    SC_CTOR(feature_extractoribs):  ACMP_sitofp_U ("ACMP_sitofp_U") {
